...
router.get(`${endPointCuentas}/:id?`, jsonWebToken_1.ValidarToken, cuentaContable_controller_1.getCuentasContables);
router.post(`${endPointCuentas}`, cuentaContable_controller_1.postCuentaContable);
